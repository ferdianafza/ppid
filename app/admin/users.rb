ActiveAdmin.register User do
  ...
  #
  # permit_params do
  #   permitted = [:email, :encrypted_password, :reset_password_token, :reset_password_sent_at, :remember_created_at, :name, :username, :ktp, :nama_lengkap, :telepon, :alamat, :pekerjaan]
